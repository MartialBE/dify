...
from models.dataset import Dataset, Document, DatasetQuery, DatasetProcessRule, AppDatasetJoin, DocumentSegment, QADocument
...
class QADocumentService:
    @staticmethod
    def get_qa_document(dataset_id: str, qa_document_id: str) -> Optional[QADocument]:
    ...
    @classmethod
    def create_qa_document(cls, args: dict, dataset: Dataset):
        ...
        # save vector index
        try:
            VectorService.create_qa_document_vector(qa_document, dataset)
        except Exception as e:
    ...
    @classmethod
    def update_qa_document(cls, args: dict, qa_document: QADocument, dataset: Dataset):
        ...
        # update vector index
        try:
            VectorService.update_qa_document_vector(qa_document, dataset)
        except Exception as e:
    ...
    @classmethod
    def delete_qa_document(cls, qa_document: QADocument, dataset: Dataset):
        # delete vector index
        try:
            VectorService.delete_qa_document_vector(qa_document, dataset)
        except Exception as e:
